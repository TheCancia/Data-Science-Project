...
Ottenuti i dati possiamo subito richiedere una chartSeries che includa il prezzo di chiusura.
```{r, echo = FALSE}
TSLA %>% 
  Ad() %>%
  chartSeries()
```
Prima di iniziare ad analizzare in modo più approfondito questo titolo, visualizziamolo tramite una Chart Series, ovvero l'espressione del prezzo di chiusura di un titolo azionario (in questo caso Tsla), di primo impatto ci rendiamo conto che ha subito una flessione importante, ma questo grafico ci dice ben poco, andiamo ad approfondire meglio questo andamento tramite qualche indicatore tecnico. 
